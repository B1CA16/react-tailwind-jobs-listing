...
const JobListing = ({ job }) => {
  ...
  return (
    <div className="dark:bg-neutral-800 bg-white rounded-xl p-4 shadow-md relative flex flex-col justify-between">
      <div className="flex-grow">
        <div className="mb-6">
          <div className="dark:text-neutral-300 text-gray-600 my-2">
            {job.type}
          </div>
        ...
        <button
          ...
          className="text-indigo-500 hover:text-indigo-700 mb-5 self-start"
        >
